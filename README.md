...
|Name|Internal version (last updated: September 11, 2024)|
|---|---|
...
|**Windows 10 22H2, Windows 10 Enterprise LTSC 2021**|**Build 1904x.4894**|
|**Windows Server 2022**|**Build 20348.2700**|
|**Windows 11 21H2**|**Build 22000.3197**|
|**Windows 11 23H2**|**Build 22631.4169**|
|**Windows 11 24H2**|**Build 26100.1742 (Pre-Release)**|
