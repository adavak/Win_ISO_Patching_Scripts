...
|名称|内部版本（最后更新：2023年2月15日）|
|---|---|
|**Windows 10 Enterprise LTSB 2016、Windows Server 2016**|**Build 14393.5717**|
|**Windows 10 Enterprise LTSC 2019、Windows Server 2019**|**Build 17763.4010**|
|**Windows 10 2004、20H2、21H1、21H2、22H2、Windows 10 Enterprise LTSC 2021**|**Build 1904x.2604**|
|**Windows Server 2022**|**Build 20348.1547**|
|**Windows 11 21H2**|**Build 22000.1574**|
